...
from robyn.modeling.clustering.model_clusterer import ClusteringResults
...
class ClusterBuilder:
    ...
    def cluster_models(self, config: ClusteringConfig) -> ClusteringResults:
        """
        ...
        Returns:
            ClusteringResults: The results of the clustering process, including cluster assignments and confidence intervals.
        """
        pass
    ...
    def prepare_data_for_clustering(self, config: ClusteringConfig) -> pd.DataFrame:
        """
    ...
    def bootstrap_sampling(self, sample: List[float], boot_n: int) -> Dict[str, float]:
        """
