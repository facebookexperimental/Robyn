    ...
    def update(cls, obj: "MMMDataCollection", **kwargs) -> "MMMDataCollection":
        ...
        return cls(
            ...
            intermediate_data=IntermediateData(
                ...
                dt_modRollWind=kwargs.get(
                    "dt_modRollWind", obj.intermediate_data.dt_modRollWind
                ),
                xDecompAggPrev=kwargs.get(
                    "xDecompAggPrev", obj.intermediate_data.xDecompAggPrev
                ),
            ),
            model_parameters=ModelParameters(
                dayInterval=kwargs.get("dayInterval", obj.model_parameters.dayInterval),
                intervalType=kwargs.get(
                    "intervalType", obj.model_parameters.intervalType
                ),
                mediaVarCount=kwargs.get(
                    "mediaVarCount", obj.model_parameters.mediaVarCount
                ),
                exposure_vars=kwargs.get(
                    "exposure_vars", obj.model_parameters.exposure_vars
                ),
                all_media=kwargs.get("all_media", obj.model_parameters.all_media),
                all_ind_vars=kwargs.get(
                    "all_ind_vars", obj.model_parameters.all_ind_vars
                ),
            ...
            time_window=TimeWindow(
                ...
                rollingWindowStartWhich=kwargs.get(
                    "rollingWindowStartWhich", obj.time_window.rollingWindowStartWhich
                ),
                window_end=kwargs.get("window_end", obj.time_window.window_end),
                rollingWindowEndWhich=kwargs.get(
                    "rollingWindowEndWhich", obj.time_window.rollingWindowEndWhich
                ),
                rollingWindowLength=kwargs.get(
                    "rollingWindowLength", obj.time_window.rollingWindowLength
                ),
                totalObservations=kwargs.get(
                    "totalObservations", obj.time_window.totalObservations
                ),
                refreshAddedStart=kwargs.get(
                    "refreshAddedStart", obj.time_window.refreshAddedStart
                ),
            ),
