...
class Robyn:
    ...
    def model_evaluation(
        ...
        pareto_optimizer = ParetoOptimizer(
            self.mmm_data, self.model_outputs, self.hyperparameters, self.featurized_mmm_data, self.holidays_data
        )
        ...
        self.logger.info(
            "MediaVecCollect: %s, %s", pareto_result.media_vec_collect.shape, pareto_result.media_vec_collect
        )
