...
class MediaResponseVisualizer(BaseVisualizer):
    ...
    def plot_saturation(self) -> plt.Figure:
        ...
        try:
            ...
            logger.error(
                "Failed to generate saturation plot: %s", str(e), exc_info=True
            )
            raise
    ...
    def plot_spend_exposure_fit(self) -> plt.Figure:
        ...
        try:
            ...
            logger.error(
                "Failed to generate spend exposure fit plot: %s", str(e), exc_info=True
            )
            raise
