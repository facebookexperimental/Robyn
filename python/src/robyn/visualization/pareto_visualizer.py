...
class ParetoVisualizer(BaseVisualizer):
    ...
    def generate_waterfall(
        ...
        print("debug solution id at generate_waterfall", solution_id)
    ...
    def plot_all(self, display_plots: bool = True, export_location: Union[str, Path] = None) -> None:
        ...
        # Debug print the cleaned solution IDs
        print("debug solution ids at plot_all", self.pareto_result.pareto_solutions)
