# CLASS
## AllocationPlotter
* The `AllocationPlotter` class extends the BaseVisualizer class at this path: from robyn.visualization.codegen.base_visualizer_revised import BaseVisualizer
