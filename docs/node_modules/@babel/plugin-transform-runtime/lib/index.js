...
var _default = (0, _helperPluginUtils.declare)((api, options, dirname) => {
  ...
  function createRegeneratorPlugin(options) {
    ...
    return (api, _, filename) => {
      return (0, _babelPluginPolyfillRegenerator.default)(api, options, filename);
    };
  }
  ...
  return {
    ...
    inherits: injectCoreJS2 ? createCorejsPlgin(_babelPluginPolyfillCorejs.default, {
      method: "usage-pure",
      [pluginsCompat]: {
        runtimeVersion,
    ...
    })) : injectCoreJS3 ? createCorejsPlgin(_babelPluginPolyfillCorejs2.default, {
      method: "usage-pure",
      version: 3,
      proposals,
      [pluginsCompat]: {
