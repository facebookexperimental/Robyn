...
var Rx = _interopDefault(require('rx'));
...
Joi.object().keys({
  ...
  interval:
  /*#__PURE__*/
  Joi.number().integer().min(0).default(250),
  log:
  /*#__PURE__*/
  ...
  timeout:
  /*#__PURE__*/
  Joi.number().integer().min(0).default(Infinity),
  verbose:
  /*#__PURE__*/
  Joi.boolean().default(false),
  window:
  /*#__PURE__*/
  Joi.number().integer().min(0).default(750)
});
...
//# sourceMappingURL=wait-file.cjs.development.js.map
