...
exports.getVersionsJSONFile = exports.getVersionedSidebarsDir = exports.getVersionedDocsDir = void 0;
...
function default_1(siteDir, options = { disableVersioning: false }) {
    const versioning = {
        enabled: false,
        versions: [],
        latestVersion: null,
