...
export declare const getActivePlugin: (allPluginDatas: Record<string, GlobalPluginData>, pathname: string) => ActivePlugin | undefined;
...
export {};
//# sourceMappingURL=docsClientUtils.d.ts.map