...
`)),
        React.createElement("div", { className: styles.baseUrlIssueBanner, style: {
            ...
            React.createElement("p", null,
                ...
                ' ',
                React.createElement("a", { href: "https://v2.docusaurus.io/docs/docusaurus.config.js/#baseurl", style: { fontWeight: 'bold' } }, "baseUrl configuration"),
                "."),
            React.createElement("p", null,
                "Current configured baseUrl =",
                ' ',
                React.createElement("span", { style: { fontWeight: 'bold', color: 'red' } }, baseUrl),
                ' ',
                baseUrl === '/' ? ' (default value)' : ''),
            React.createElement("p", null,
                "We suggest trying baseUrl =",
                ' ',
                React.createElement("span", { style: { fontWeight: 'bold', color: 'green' }, id: BaseUrlIssueBannerContainerId }),
                ' '))));
}
