...
function(InputCollect, jsonRunArgs) {
  ...
  InputCollect$dt_input  <- InputCollect$dt_input %>% as_tibble()
  InputCollect$dt_holidays  <- InputCollect$dt_holidays %>% as_tibble()
  InputCollect$dt_mod  <- InputCollect$dt_mod %>% as_tibble()
  InputCollect$dt_modRollWind  <- InputCollect$dt_modRollWind %>% as_tibble()
  InputCollect$dt_inputRollWind  <- InputCollect$dt_inputRollWind %>% as_tibble()
  if(length(InputCollect$calibration_input)==0) {InputCollect$calibration_input <- NULL}
...
#* @post /robyn_outputs
function(InputCollect, OutputModels, jsonRunArgs) {
  ...
  # OutputModels$trial1$resultCollect$resultHypParam <- OutputModels$trial1$resultCollect$resultHypParam %>% as_tibble()
  # OutputModels$trial1$resultCollect$xDecompAgg <- OutputModels$trial1$resultCollect$xDecompAgg %>% as_tibble()
