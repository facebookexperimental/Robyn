...
source(paste(script_path, "fb_nextgen_mmm_v19.8.func.R", sep=""))
source(paste(script_path, "fb_nextgen_mmm_v19.8.plot.R", sep=""))
source(paste(script_path, "fb_nextgen_mmm_v19.8.optm.R", sep=""))
...
## set training size
set_modTrainSize <- 0.8 # 0.8 means taking 80% of data to train and 20% to test the model
...
# no need to change
set_hyperBoundGlobal <- list(thetas = c(0, 0.9999) # geometric decay rate
                          ,shapes = c(0.0001, 2) # weibull parameter that controls the decay shape between exponential and s-shape
                          ,scales = c(0, 0.5) # weibull parameter that controls the position of inflection point
                          ,alphas = c(0.0001, 3) # hill function parameter that controls the decay shape between exponential and s-shape
...
#   ,facebook_I_gammas = c(0.087, 0.405)
#   ,facebook_I_thetas = c(0.88)
#   #,facebook_I_scales = c(0.2)
#   #,facebook_I_shapes = c(0.0001, 1)
#   ,ooh_S_alphas = c(0.1, 3)
#   ,ooh_S_gammas = c(0.1, 0.9)
#   ,ooh_S_thetas = c(0.7)
#   #,ooh_S_scales = c(0.1, 0.4)
#   #,ooh_S_shapes = c(0.1, 2)
#   ,print_S_alphas = c(0.1, 3)
#   ,print_S_gammas = c(0.1, 0.9)
#   ,print_S_thetas = c(0.3)
#   #,print_S_scales = c(0.4)
#   #,print_S_shapes = c(0.1, 2)
#   ,tv_S_alphas = c(2.238, 3)
#   ,tv_S_gammas = c(0.5)
